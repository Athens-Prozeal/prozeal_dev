...
import PlantBoundaryAndFencingTable from '@/components/menu/inspection/plant-boundary-and-fencing/table';
      ...
      <Stack direction="row" spacing={3}>
        ...
        {role === 'epc_admin' || role === 'epc' || role === 'quality_inspector' ? (
          <Button
            ...
            href={'/menu/inspection/plant-boundary-and-fencing/add'}
