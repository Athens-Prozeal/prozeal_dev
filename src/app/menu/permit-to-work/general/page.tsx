...
import PermitToWorkTable, { PermitToWorkHandles } from '@/components/menu/permit-to-work/general/table';

export default function Page() {
  const role = localStorage.getItem('role');
  const exportRef = useRef<PermitToWorkHandles>(null);
  ...
  return (
    <Stack spacing={3}>
      ...
      <Stack>
        <PermitToWorkTable ref={exportRef} />
      </Stack>
    </Stack>
  );
}
