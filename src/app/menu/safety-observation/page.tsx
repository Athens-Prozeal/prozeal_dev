...
import SafetyObservationTable, { SafetyObservationHandles } from '@/components/menu/safety-observation/table';

export default function Page() {
  const role = localStorage.getItem('role');
  const exportRef = useRef<SafetyObservationHandles>(null);
  ...
  return (
    <Stack spacing={3}>
      <Stack direction="row" spacing={3}>
        ...
        {role === 'epc_admin' || role === 'epc'? (
          <Button
            ...
            href={'/menu/safety-observation/add'}
      ...
      <Stack>
        <SafetyObservationTable ref={exportRef} />
      </Stack>
    </Stack>
  );
}
