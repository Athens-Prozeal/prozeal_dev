...
let allNavItems: NavItemConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {key: 'ac-distribution-board', title: 'AC Distribution Board', href: paths.menu.inspection.acDistributionBoard.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.acDistributionBoard.home },},
      {key: 'aux-transformer', title: 'AUX Transformer', href: paths.menu.inspection.auxTransformer.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.auxTransformer.home },},
      {key: 'busduct', title: 'Busduct', href: paths.menu.inspection.busduct.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.busduct.home },},
      {key: 'high-voltage-panel', title: 'High Voltage Panel', href: paths.menu.inspection.highVoltagePanel.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.highVoltagePanel.home },},
      {key: 'periphery-lighting', title: 'Periphery Lighting', href: paths.menu.inspection.peripheryLighting.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.peripheryLighting.home },},
      ...
      {key: 'battery-bank-and-battery-charger', title: 'Battery Bank And Battery Charger', href: paths.menu.inspection.batteryBankAndBatteryCharger.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.batteryBankAndBatteryCharger.home },},
