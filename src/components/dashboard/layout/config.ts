...
let allNavItems: NavItemConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {key: 'battery-bank-and-battery-charger', title: 'Battery Bank And Charger', href: paths.menu.inspection.batteryBankAndBatteryCharger.home, matcher: { type: 'startsWith' as const, href: paths.menu.inspection.batteryBankAndBatteryCharger.home },},
