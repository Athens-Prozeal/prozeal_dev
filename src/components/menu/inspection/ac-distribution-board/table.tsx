...
const AcDistributionBoardTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/ac-distribution-board/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'serial_no', headerName: 'Serial No', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/ac-distribution-board/view?acDistributionBoardId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default AcDistributionBoardTable;
