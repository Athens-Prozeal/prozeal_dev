...
const antiTermiteTreatmentDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const antiTermiteTreatmentId = searchParams.get('antiTermiteTreatmentId');
...
export default antiTermiteTreatmentDetail;
