...
const AuxTransformerDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const auxTransformerId = searchParams.get('auxTransformerId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/aux-transformer/${auxTransformerId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR AUX TRANSFORMER
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default AuxTransformerDetail;
