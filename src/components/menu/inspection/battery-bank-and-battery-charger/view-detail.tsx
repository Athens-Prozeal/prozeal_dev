...
const BatteryBankDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const batteryBankId = searchParams.get('batteryBankId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/battery-bank-and-battery-charger/${batteryBankId}/?work_site_id=${workSiteId}`, {
        headers: {
...
export default BatteryBankDetail;
