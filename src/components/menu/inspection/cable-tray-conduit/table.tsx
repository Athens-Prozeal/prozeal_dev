    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/cable-tray-conduit/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'location', headerName: 'Location Area:', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/cable-tray-conduit/view?cableTrayConduitId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default CableTrayConduitTable;
