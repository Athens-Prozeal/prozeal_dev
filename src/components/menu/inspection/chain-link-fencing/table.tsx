    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/chain-link-fencing/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'project_name_and_capacity', headerName: 'Project Name And Capacity', filter: 'agTextColumnFilter' },
          { field: 'client_name', headerName: 'Client Name', filter: 'agTextColumnFilter' },
          { field: 'consultant_name', headerName: 'Consultant Name', filter: 'agTextColumnFilter' },
          { field: 'epc_contractor_name', headerName: 'EPC Contractor Name', filter: 'agTextColumnFilter' },
          { field: 'location_or_area', headerName: 'Location / Area', filter: 'agTextColumnFilter' },
          { field: 'drawing_no', headerName: 'Drawing No', filter: 'agTextColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/chain-link-fencing/view?ChainLinkFencingId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default ChainLinkFencingTable;
