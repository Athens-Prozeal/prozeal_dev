    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/earthing-system/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          { field: 'name_of_client', headerName: 'Name of Client', filter: 'agTextColumnFilter' },
          { field: 'location', headerName: 'Location', filter: 'agTextColumnFilter' },
          { field: 'date_of_test', headerName: 'Date Of Test', filter: 'agDateColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/earthing-system/view?earthingSystemId=`,
            },
            minWidth: 150,
          },
        ]);
