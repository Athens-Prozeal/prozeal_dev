    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/fire-alarm-panel/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'serial_no', headerName: 'Serial.No', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/fire-alarm-panel/view?fireAlarmPanelId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default FireAlarmPanelTable;
