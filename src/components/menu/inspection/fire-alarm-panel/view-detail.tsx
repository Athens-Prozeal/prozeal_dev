...
const FireAlarmPanelDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const fireAlarmPanelId = searchParams.get('fireAlarmPanelId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/fire-alarm-panel/${fireAlarmPanelId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR  FIRE ALARM PANEL
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default FireAlarmPanelDetail;
