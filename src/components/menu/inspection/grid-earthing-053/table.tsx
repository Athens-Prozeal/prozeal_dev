    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/grid-earthing-053/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'drawing_specification_no', headerName: 'Drawing / Specification No', filter: 'agTextColumnFilter' },
          { field: 'location', headerName: 'Site Location / Area:', filter: 'agTextColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/grid-earthing-053/view?gridEarthingId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default GridEarthingTable;
