    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/high-voltage-panel/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'serial_no', headerName: 'Serial.No', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/high-voltage-panel/view?highVoltagePanelId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default HighVoltagePanelTable;
