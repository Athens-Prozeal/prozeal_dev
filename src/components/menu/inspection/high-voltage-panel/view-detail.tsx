...
const HighVoltagePanelDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const highVoltagePanelId = searchParams.get('highVoltagePanelId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/high-voltage-panel/${highVoltagePanelId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR HIGH VOLTAGE PANEL
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default HighVoltagePanelDetail;
