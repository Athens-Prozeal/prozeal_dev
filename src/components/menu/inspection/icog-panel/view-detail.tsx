...
const ICOGPanelDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const icogPanelId = searchParams.get('icogPanelId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/icog-panel/${icogPanelId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR ICOG PANEL
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default ICOGPanelDetail;
