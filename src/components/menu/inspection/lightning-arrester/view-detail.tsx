...
const LightningArresterDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const lightningArresterId = searchParams.get('lightningArresterId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/lightning-arrester/${lightningArresterId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR LIGHTNING ARRESTER
                </Typography>
              </Box>
            </Stack>
          </Grid>
