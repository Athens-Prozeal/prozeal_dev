...
import WitnessTable from '@/components/menu/inspection/witnesses/witness-2-table';

const OutdoorIsolatorOrEarthSwitchDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const outdoorIsolatorOrEarthSwitchId = searchParams.get('outdoorIsolatorOrEarthSwitchId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/outdoor-isolator-or-earth-switch/${outdoorIsolatorOrEarthSwitchId}/?work_site_id=${workSiteId}`, {
        headers: {
  ...
  }, [outdoorIsolatorOrEarthSwitchId]);
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR OUTDOOR ISOLATOR / EARTH SWITCH
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default OutdoorIsolatorOrEarthSwitchDetail;
