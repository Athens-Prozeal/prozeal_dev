    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/painting/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'site_location_or_area', headerName: 'Site Location / Area', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/painting/view?paintingId=`,
            },
            minWidth: 150,
          },
        ]);
