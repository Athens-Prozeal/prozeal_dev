    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/periphery-lighting/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'block_no', headerName: 'Block No', filter: 'agTextColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/periphery-lighting/view?peripheryLightingId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default PeripheryLightingTable;
