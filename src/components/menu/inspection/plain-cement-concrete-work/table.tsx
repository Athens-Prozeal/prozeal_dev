...
const plainCementConcreteWorkTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/plain-cement-concrete-work/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'grade_mix_pro_portion_of_concrete', headerName: 'Grade/ Mix proportion of concrete', filter: 'agTextColumnFilter' },
          { field: 'source_of_concrete', headerName: 'Source Of Concrete', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/plain-cement-concrete-work/view?plainCementConcreteWorkId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default plainCementConcreteWorkTable;
