...
const PlantBoundaryAndFencingTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/plant-boundary-and-fencing/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'location_or_area', headerName: 'Location / Area', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/plant-boundary-and-fencing/view?plantBoundaryAndFencingId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default PlantBoundaryAndFencingTable;
