...
const pourCardForPlinthBeamDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const pourCardForPlinthBeamId = searchParams.get('pourCardForPlinthBeamId');
...
export default pourCardForPlinthBeamDetail;
