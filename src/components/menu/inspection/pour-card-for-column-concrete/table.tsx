...
const PourCardForColumnConcreteTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/pour-card-for-column-concrete/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'source_of_concrete', headerName: 'Source Of Concrete', filter: 'agTextColumnFilter' },
          {
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/pour-card-for-column-concrete/view?pourCardForColumnConcreteId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default PourCardForColumnConcreteTable;
