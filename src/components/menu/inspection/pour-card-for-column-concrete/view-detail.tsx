...
const pourCardForColumnConcreteDetail: React.FC = () => {
  ...
  const pourCardForColumnConcreteId = searchParams.get('pourCardForColumnConcreteId');
...
export default pourCardForColumnConcreteDetail;
