...
const PourCardforSlabConcreteSchemacreteTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/pour-card-for-slab-concrete/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          { field: 'date_of_checking', headerName: 'Date Of Checking', filter: 'agDateColumnFilter' },
          ...
          { field: 'grade_of_concrete', headerName: 'Grade Of Concrete', filter: 'agTextColumnFilter' },
          { field: 'level', headerName: 'Level', filter: 'agTextColumnFilter' },
          { field: 'source_of_concrete', headerName: 'Source Of Concrete', filter: 'agTextColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/pour-card-for-slab-concrete/view?pourCardForSlabConcreteId=`,
            },
            minWidth: 150,
          },
        ]);
...
export default PourCardforSlabConcreteSchemacreteTable;
