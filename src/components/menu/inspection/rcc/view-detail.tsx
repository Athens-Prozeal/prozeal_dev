...
const RCCDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const rccId = searchParams.get('rccId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/rcc/${rccId}/?work_site_id=${workSiteId}`, {
        headers: {
