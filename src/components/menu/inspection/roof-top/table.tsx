    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${config.site.serverURL}/api/inspection/roof-top/?work_site_id=${localStorage.getItem('work-site-id')}${statusParam}`,
          {
            headers: {
        ...
        setColDefs([
          ...
          { field: 'location', headerName: 'Location/Area', filter: 'agTextColumnFilter' },
          {
            field: 'actions',
            ...
            cellRendererParams: {
              ...
              router: router,
              viewUrl: `/menu/inspection/roof-top/view?roofTopId=`,
            },
            minWidth: 150,
          },
        ]);
