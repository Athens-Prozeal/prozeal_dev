...
const StringCablesDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const stringCablesId = searchParams.get('stringCablesId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/string-cables2/${stringCablesId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR STRING CABLES
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default StringCablesDetail;
