...
const TransmissionLinesDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const transmissionlinesId = searchParams.get('transmissionlinesId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/transmission-lines/${transmissionlinesId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR TRANSMISSION LINES
                </Typography>
              </Box>
            </Stack>
          </Grid>
...
export default TransmissionLinesDetail;
