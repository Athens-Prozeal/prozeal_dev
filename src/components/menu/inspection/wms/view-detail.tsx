...
const WmsDetail: React.FC = () => {
  const searchParams = useSearchParams();
  const workSiteId = localStorage.getItem('work-site-id');
  const wmsId = searchParams.get('wmsId');
  ...
  useEffect(() => {
    axios
      .get(`${config.site.serverURL}/api/inspection/wms/${wmsId}/?work_site_id=${workSiteId}`, {
        headers: {
            ...
            <Stack direction="column" height="100%">
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  INSTALLATION CHECKLIST FOR WMS
                </Typography>
              </Box>
            </Stack>
          </Grid>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>
                      <strong>Checklist Points</strong>
                    </TableCell>
                    <TableCell>
